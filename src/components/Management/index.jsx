...
function Manage() {
  return (
    <div id="about" className="flex justify-center my-20 w-full">
      <div className="grid grid-cols-1 lg:grid-cols-2 justify-items-center items-start lg:gap-24 xl:gap-10 items-center lg:ml-[4%]">
        <div>
          <img className="xl:w-[95%]" src={Rasm} alt="" />
        </div>
        <div>
          <div className="lg:p-0 p-5">
            <h2 className="text-[#2a2a2a] lg:font-extrabold md:justify-items-center font-bold text-[30px] block justify-items-center xl:w-[75%] lg:p-0 lg:w-[85%] w-[95%]">
            ...
            <div className="grid lg:grid-cols-3 mx-24 lg:-ml-[1%] grid-cols-1 gap-2 justify-items-center lg:justify-items-start ">
              <div className="lg:text-start text-center grid lg:justify-items-start justify-items-center">
                <img src={Rasm2} alt="" />
                <p className="text-[48px] font-extrabold text-[#2a2a2a]">320</p>
                <p
                  style={{ lineHeight: "2" }}
                ...
                <p
                  ...
                  className="w-[80%] text-[14px] lg:w-[90%]"
                >
              ...
              <div className="lg:text-start text-center grid lg:justify-items-start justify-items-center">
                <img src={Rasm3} alt="" />
                <p className="text-[48px] font-extrabold text-[#2a2a2a]">640</p>
                <p
                  style={{ lineHeight: "2" }}
                  className="text-[15px] text-[#ff695f] border-b w-[80%] pb-8 mb-8"
                >
              ...
              <div className="lg:text-start text-center grid lg:justify-items-start justify-items-center">
                <img src={Rasm4} alt="" />
                <p className="text-[48px] font-extrabold text-[#2a2a2a]">120</p>
                <p
                  style={{ lineHeight: "2" }}
